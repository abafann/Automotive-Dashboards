...
const DATA_URL = 'https://cdn.jsdelivr.net/gh/abafann/Automotive-Dashboards@main/electrolytes-radar-data.min.json';

// Tech to highlight with a pulsing halo. Must match a `name` field in the data exactly.
// Set to null to disable.
const HIGHLIGHT_NAME = 'Mixed LiPF6 / LiFSI electrolyte systems';

let DATA = null;

const CATEGORIES = [
  { id: 'Solid electrolytes',                    short: 'Solid',          color: '#14B8A6' },
  { id: 'Liquid lithium-ion electrolytes',       short: 'Liquid Li-ion',  color: '#4756FF' },
  { id: 'Electrode interphases',                 short: 'Interphases',    color: '#8B5CF6' },
  { id: 'Separators',                            short: 'Separators',     color: '#F0438C' },
  { id: 'Gel and polymer electrolytes',          short: 'Gel & polymer',  color: '#5DECFF' },
  { id: 'Sodium-ion electrolytes',               short: 'Sodium-ion',     color: '#F79009' },
  { id: 'Concentrated electrolytes',             short: 'Concentrated',   color: '#6366F1' },
  { id: 'Lithium-metal liquid electrolytes',     short: 'Li-metal liq.',  color: '#EAB308' },
  { id: 'Catholytes and interface electrolytes', short: 'Catholytes',     color: '#10B981' },
];
...
let activeCategory = 'Liquid lithium-ion electrolytes';
...
async function init() {
  ...
  try {
    ...
    console.error('Electrolytes radar: failed to load data from', DATA_URL, err);
    if (status) {
