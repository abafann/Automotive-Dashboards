...
const DATA_URL = 'https://cdn.jsdelivr.net/gh/abafann/Automotive-Dashboards@main/battery-chemistries-radar-data.min.json';

// Tech to highlight with a pulsing halo. Must match a `name` field in the data exactly.
// Set to null to disable.
const HIGHLIGHT_NAME = 'Sodium Ion';
...
async function init() {
  ...
  try {
    ...
    console.error('Battery-chemistries radar: failed to load data from', DATA_URL, err);
    if (status) {
