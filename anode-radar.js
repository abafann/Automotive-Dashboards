...
const DATA_URL = 'https://cdn.jsdelivr.net/gh/abafann/Automotive-Dashboards@main/anode-radar-data.min.json';

// Tech to highlight with a pulsing halo. Must match a `name` field in the data exactly.
// Set to null to disable.
const HIGHLIGHT_NAME = 'Hard-carbon sodium-ion anodes';

let DATA = null;

const CATEGORIES = [
  { id: 'Graphite anodes',             short: 'Graphite',       color: '#4756FF' },
  { id: 'High-power insertion anodes', short: 'High-power',     color: '#5DECFF' },
  { id: 'Silicon-containing anodes',   short: 'Silicon',        color: '#14B8A6' },
  { id: 'Lithium-metal anodes',        short: 'Lithium-metal',  color: '#8B5CF6' },
  { id: 'Sodium-ion anodes',           short: 'Sodium-ion',     color: '#F79009' },
];
...
let activeCategory = 'Sodium-ion anodes';
...
async function init() {
  ...
  try {
    ...
    console.error('Anode radar: failed to load data from', DATA_URL, err);
    if (status) {
