...
const DATA_URL = 'https://cdn.jsdelivr.net/gh/abafann/Automotive-Dashboards@main/manufacturing-radar-data.min.json';

// Tech to highlight with a pulsing halo. Must match a `name` field in the data exactly.
// Set to null to disable.
const HIGHLIGHT_NAME = 'Anode prelithiation';

let DATA = null;

const CATEGORIES = [
  { id: 'Solid-state manufacturing',              short: 'Solid-state mfg',  color: '#4756FF' },
  { id: 'Prelithiation and sodium compensation',  short: 'Prelithiation',    color: '#F79009' },
];
...
let activeCategory = 'Prelithiation and sodium compensation';
...
async function init() {
  ...
  try {
    ...
    console.error('Manufacturing radar: failed to load data from', DATA_URL, err);
    if (status) {
