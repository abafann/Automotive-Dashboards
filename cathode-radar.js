...
const DATA_URL = 'https://cdn.jsdelivr.net/gh/abafann/Automotive-Dashboards@main/cathode-radar-data.min.json';

// Tech to highlight with a pulsing halo. Must match a `name` field in the data exactly.
// Set to null to disable.
const HIGHLIGHT_NAME = 'Prussian blue analogue sodium-ion cathodes';

let DATA = null;

const CATEGORIES = [
  { id: 'Layered oxide cathodes',             short: 'Layered oxide',    color: '#4756FF' },
  { id: 'Layered oxide cathode engineering',  short: 'LO engineering',   color: '#5DECFF' },
  { id: 'Phosphate cathodes',                 short: 'Phosphate',        color: '#14B8A6' },
  { id: 'Spinel cathodes',                    short: 'Spinel',           color: '#8B5CF6' },
  { id: 'Sodium-ion cathodes',                short: 'Sodium-ion',       color: '#F79009' },
];
...
let activeCategory = 'Sodium-ion cathodes';
...
async function init() {
  ...
  try {
    ...
    console.error('Cathode radar: failed to load data from', DATA_URL, err);
    if (status) {
