...
const DATA_URL = 'https://cdn.jsdelivr.net/gh/abafann/Automotive-Dashboards@main/fullcell-radar-data.min.json';

// Tech to highlight with a pulsing halo. Must match a `name` field in the data exactly.
// Set to null to disable.
const HIGHLIGHT_NAME = "Prussian white / Prussian blue analogue sodium-ion / hard-carbon cells";

let DATA = null;

const CATEGORIES = [
  { id: 'High-energy lithium-ion passenger-EV platforms',      short: 'High-energy Li-ion', color: '#4756FF' },
  { id: 'Low-cost lithium-ion passenger-EV platforms',         short: 'Low-cost Li-ion',    color: '#14B8A6' },
  { id: 'Sodium-ion passenger-EV platforms',                   short: 'Sodium-ion',         color: '#F79009' },
  { id: 'Solid-state lithium-metal platforms',                 short: 'SS Li-metal',        color: '#8B5CF6' },
  { id: 'High-voltage cobalt-free lithium-ion platforms',      short: 'Hi-V cobalt-free',   color: '#5DECFF' },
  { id: 'Semi-solid and hybrid platforms',                     short: 'Semi-solid/hybrid',  color: '#6366F1' },
  { id: 'Solid-state lithium-ion platforms',                   short: 'SS Li-ion',          color: '#10B981' },
  { id: 'High-power / niche lithium-ion platforms',            short: 'Hi-power/niche',     color: '#F0438C' },
];
...
let activeCategory = 'Sodium-ion passenger-EV platforms';
...
async function init() {
  ...
  try {
    ...
    console.error('Full-cell radar: failed to load data from', DATA_URL, err);
    if (status) {
